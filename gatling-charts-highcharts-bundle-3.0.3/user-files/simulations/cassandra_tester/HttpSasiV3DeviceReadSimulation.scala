...
class HttpSasiV3DeviceReadSimulation extends Simulation {

  val httpConf = http.baseUrl("http://cassandra-tester:8080/telemetry/sasi/")
                    .shareConnections

  val scn = scenario("Read Sasi v3 telemetry")
  .exec {
  ...
  .exec(
    http("Sasi v3 telemetry read req")
      .get("v3/1/device/3/from/1556625536000/to/1564487936000/limit/2147483647?keys=co2,nh3")
  )
