...
class HttpMvV1AssetReadSimulation extends Simulation {

  val httpConf = http.baseUrl("http://cassandra-tester:8080/telemetry/mv/")
                    .shareConnections

  val scn = scenario("Read MV v1 telemetry")
  .exec {
  ...
  .exec(
    http("MV v1 telemetry read req")
      .get("v1/1/asset-unit/2/from/1556625536000/to/1564487936000/limit/2147483647?keys=co2,nh3")
  )
