...
class HttpSidxV2DeviceReadSimulation extends Simulation {

  val httpConf = http.baseUrl("http://cassandra-tester:8080/telemetry/sidx/")
                    .shareConnections

  val scn = scenario("Read Sidx v2 telemetry")
  .exec {
  ...
  .exec(
    http("Sidx v2 telemetry read req")
      .get("v2/1/device/3/from/1556625536000/to/1564487936000/limit/2147483647?keys=co2,nh3")
  )
